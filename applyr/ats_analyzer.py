...
class ATSAnalyzer:
    ...
    def analyze_document(self, file_path: Path, job_description: Optional[Path] = None) -> ATSAnalysisResult:
        ...
        keyword_analysis = self.keyword_analyzer.analyze_keywords(parsed_content, job_description)

        # Calculate scores for each category
        scores = self.scoring_engine.calculate_scores(parsed_content, content_analysis, keyword_analysis, file_analysis)

        # Identify critical issues
        critical_issues = self._identify_critical_issues(parsed_content, content_analysis, file_analysis)

        # Generate recommendations
        recommendations = self._generate_recommendations(scores, critical_issues, keyword_analysis, content_analysis)
