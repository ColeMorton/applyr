...
class TestApplicationDatabase:
    ...
    def test_database_initialization(self, test_database, temp_dir):
        ...
        expected_columns = {
            'job_id', 'company_name', 'job_title', 'source', 'status',
            'priority', 'date_discovered', 'date_applied', 'date_closed',
            'notes', 'salary_min', 'salary_max', 'location', 'url'
        }
    ...
    def test_add_duplicate_job(self, test_database):
        ...
        # Add first job
        success1 = test_database.add_job(
            job_id='12345',
            company_name='Test Company',
            job_title='Software Engineer'
        )
        ...
        success2 = test_database.add_job(
            job_id='12345',
