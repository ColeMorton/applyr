...
import pytest
from applyr.scraper_factory import (
    detect_job_source,
    normalize_to_url,
    create_scraper
)
...
class TestDetectJobSource:
    ...
    def test_detect_seek_id(self):
        ...
        assert detect_job_source("87066700") == "seek"
    ...
    def test_detect_seek_url(self):
        ...
        assert detect_job_source("https://www.seek.com.au/job/87066700") == "seek"
        assert detect_job_source("http://www.seek.com.au/job/12345678") == "seek"
        assert detect_job_source("https://seek.com.au/job/87066700") == "seek"
...
class TestNormalizeToUrl:
    ...
    def test_normalize_seek_id(self):
        ...
        result = normalize_to_url("87066700", "seek")
        assert result == "https://www.seek.com.au/job/87066700"
    ...
    def test_normalize_invalid_source(self):
        ...
        with pytest.raises(ValueError):
            normalize_to_url("87066700", "invalid_source")
...
class TestCreateScraper:
    ...
    def test_create_seek_scraper_from_id(self, test_database):
        ...
        scraper, url = create_scraper("87066700", delay=2.0, database=test_database)
        
        assert isinstance(scraper, SEEKScraper)
        assert url == "https://www.seek.com.au/job/87066700"
    ...
    def test_create_scraper_without_database(self):
        ...
        scraper, url = create_scraper("87066700")
    ...
    def test_create_scraper_default_delay(self):
        ...
        scraper, _ = create_scraper("87066700")
        assert scraper.delay == 2.0
    ...
    def test_scraper_has_source_name(self):
        ...
        seek_scraper, _ = create_scraper("87066700")
